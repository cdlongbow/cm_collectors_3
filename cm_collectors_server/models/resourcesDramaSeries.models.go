...
type ResourcesDramaSeries struct {
	...
	VideoMetadataExcluded bool                    `json:"videoMetadataExcluded" gorm:"column:video_metadata_excluded;type:tinyint(1);default:0;index:idx_drama_series_metadata_excluded"`
