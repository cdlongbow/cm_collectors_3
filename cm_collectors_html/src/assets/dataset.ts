export default {
  ...
  resourceSort: ['addTimeDesc', 'addTimeAsc', 'issuingDateDesc', 'issuingDateAsc', 'issueNumberDesc', 'issueNumberAsc', 'scoreDesc', 'scoreAsc', 'starDesc', 'starAsc', 'titleDesc', 'titleAsc', 'resourceSizeDesc', 'resourceSizeAsc', 'durationDesc', 'durationAsc', 'bitRateDesc', 'bitRateAsc', 'history', 'hot', 'random'],
  leftDisplay: ['sort', 'country', 'definition', 'videoCodec', 'year', 'starRating', 'performer', 'diyTag'],
  ...
  resourcesShowMode: ['coverPoster', 'coverPosterCinemaGallery', 'coverPosterBox', 'coverPosterBoxWideSeparate', 'coverPosterSimple', 'coverPosterSimpleExpand', 'coverPosterWaterfall', 'coverPosterMosaic', 'coverPosterMosaicShortVideo', 'coverPosterCompactWall', 'shortVideo', 'shortVideoTopBottom', 'table'],
  coverImageFit: ['fill', 'contain', 'cover', 'none', 'scale-down'],
