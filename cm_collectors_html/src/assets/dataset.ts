export default {
  ...
  resourceSort: ['addTimeDesc', 'addTimeAsc', 'issuingDateDesc', 'issuingDateAsc', 'issueNumberDesc', 'issueNumberAsc', 'scoreDesc', 'scoreAsc', 'starDesc', 'starAsc', 'titleDesc', 'titleAsc', 'resourceSizeDesc', 'resourceSizeAsc', 'history', 'hot', 'random'],
